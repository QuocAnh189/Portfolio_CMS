...
@section('content')
    <section class="section">
        ...
        <div class="mb-3">
            <a class="btn btn-primary" href="{{ route('admin.projects.projectTechnologies.index', $project) }}">Back</a>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form
                                action="{{ route('admin.projects.projectTechnologies.update', [$project, $projectTechnology]) }}"
