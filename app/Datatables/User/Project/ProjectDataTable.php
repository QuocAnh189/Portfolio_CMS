            ...
            ->addColumn('action', function ($query) {
                ...
                $moreBtn =
                    '<div class="dropdown dropleft d-inline">
                        ...
                        <a class="dropdown-item has-icon" href="' . route('user.projects.index') . '"><i class="far fa-heart"></i> Image Gallery</a>
                        <a class="dropdown-item has-icon" href="' . route('user.projects.index') . '"><i class="far fa-file"></i> Feature</a>
                        <a class="dropdown-item has-icon" href="' . route('user.projects.index') . '"><i class="far fa-file"></i> Technology</a>
                        <a class="dropdown-item has-icon" href="' . route('user.projects.index') . '"><i class="far fa-file"></i> Link</a>
                        </div>
                    </div>';
