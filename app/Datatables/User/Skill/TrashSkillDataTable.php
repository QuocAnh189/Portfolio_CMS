...
class TrashSkillDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($query) {
                $form = "<form action='" . route('user.skills.restore', $query->id) . "' method='POST' enctype='multipart/form-data' style='display:inline-block'>";
                $form .= csrf_field();
                ...
                $form .= "<form action='" . route('user.skills.delete', $query->id) . "' method='POST' enctype='multipart/form-data' class='delete-item' style='display:inline-block'>";
                $form .= csrf_field();
    ...
    {
        return $model->newQuery()->with('user')->with('role_software')->where('user_id', Auth::id())->onlyTrashed();;
    }
